...
(function () {
    ...
    const SCRIPT_ID = 'hook_localStorage_clear';
    ...
    function initHook() {
        ...
        let temp_localStorage_clear = localStorage.clear;

        localStorage.clear = function () {
            if (flag === "0") {
                console.log("捕获到移除了localStorage中的所有键值对");
                if (is_debugger === "1") {
                    debugger;
                }
                if (is_stack === "1") {
            ...
            return temp_localStorage_clear.call(this, ...arguments);
        }
